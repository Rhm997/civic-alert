...
<head>
    ...
    <script>
      ...
      require(["esri/Map", "esri/views/MapView", "esri/geometry/Extent", "esri/layers/MapImageLayer",
            "esri/layers/VectorTileLayer",
            "esri/layers/FeatureLayer", "esri/widgets/Search", "esri/Viewpoint", "esri/widgets/Legend",
            "esri/widgets/Expand", "esri/widgets/Home", "esri/core/urlUtils"
          ],
          (Map, MapView, Extent, MapImageLayer, VectorTileLayer, FeatureLayer, Search, Viewpoint, Legend, Expand, Home,
              urlUtils) => {
            ...
            const layerTomb = new MapImageLayer({
              url: "https://webadaptortaz.gisapp.ro/arcgisaplm/rest/services/Isaccea/Deseuri/FeatureServer",
              sublayers: [
                {
                  id: 0,
                  visible: true,
            ...
            const template = {
              ...
              content: ""//"capacitate:{id_capacity}"
            };

            const layerTombFeat = new FeatureLayer({
              url: "https://webadaptortaz.gisapp.ro/arcgisaplm/rest/services/Isaccea/Deseuri/FeatureServer/0",
