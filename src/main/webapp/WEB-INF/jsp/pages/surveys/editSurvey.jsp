...
<div class="viewFoldersPage">
    ...
    <div class="page-content">
        <div class="parent-survey">
            <div class="m-4 div-header" id="divGeneral">
                <form class="formTabs" data-changed="false">
                    <div class="col-12 fp-card card-form">
                        ...
                        <div id="${survey.id}" class="mb-3 mt-3 survey-header">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <textarea class="campObl form-control new-input" data-header="descriptionRo"
                                        >${survey.descriptionRo}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="input-box">
                                        <label class="input-label"> Survey description </label>
                                        <textarea class="campObl form-control new-input" data-header="descriptionEn"
                                        >${survey.descriptionEn}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <textarea class="campObl form-control new-input" data-header="notesRo"
                                        >${survey.notesRo}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="input-box">
                                        <label class="input-label"> Final notes - description</label>
                                        <textarea class="campObl form-control new-input" data-header="notesEn"
                                        >${survey.notesEn}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-12">
                                    <div class="input-box active-grey">
                                        ...
                                        <input id="dataOraInput" type="text" value=""
                                               ...
                                               data-header="startCampaign" data-value="${survey.startCampaign}"/>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="input-box">
                                        ...
                                        <input id="dataOraInput2" type="text" value=""
                                               class="form-control new-input daterange campObl" data-name="Dată și oră"
                                               data-header="endCampaign" data-value="${survey.endCampaign}"/>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="input-box">
                                        ...
                                        <input type="number"
                                               ...
                                               class="campObl form-control new-input"
                                               data-name="Telefon"
                                               value="${survey.surveyFrequencyInDays}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 fp-card card-form">
                            ...
                            <div class="mb-3 mt-3">
                                <div class="survey-question" data-questions="questions">
                                    <div id="${questions.id}" data-question="id">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <input style="display: none" data-key="id"/>
                                                <div class="input-box focus">
                                                    ...
                                                    <select data-key="" class="campObl neEdit form-control new-input"
                                                            data-name="Tip intrebare" data-question="questionType"
                                        ...
                                        <c:choose>
                                            ...
                                            <label class="input-label input-check">
                                                <input type="checkbox" class="form-check-input"
                                                       data-question="stat_map"
                                                       name="isActive" value="false"> Generează statistici în
                                                hartă
                                            </label>
                                            </c:otherwise>
                                        </c:choose>
                                            ...
                                            <label class="input-label input-check">
                                                <input type="checkbox" class="form-check-input"
                                                       data-question="stat_graph" name="isActive" value="false"
                                                       checked>
                                                Generează grafic
                                            </label>
                                            </c:when>
                                            ...
                                            <label class="input-label input-check">
                                                <input type="checkbox" class="form-check-input"
                                                       data-question="stat_fixed" name="isActive" value="false"
                                                       checked>
                                                Conținut static
                                            </label>
                                            </c:when>
                                ...
                                <div class="survey-answers" data-answer="answers">
                                    <c:forEach items="${questions.answers}" var="answers" varStatus="loop">
                                        <div class="answer-counter">
                                            <div id="${answers.id}" data-answer="id" class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <input style="display: none" data-key="id"/>
                                                    <div class="input-box">
                                    ...
                                    <%----%>
                                <div class="d-flex justify-content-end mt-4 div-add-answer edit-survey">
                                    <button id="answer_${questions.ord}" type="button"
                                            class="btn btn-add btn-primary btn-add-answer" title="Adaugă răspuns"
                                            onclick="addNewAnswer(this.id);"><i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <%----%>
            <div class="m-3">
                <div type="button" class="btn btn-primary w-100 btn-save-survey"
                     onclick="saveEditsSurvey(${survey.id})">
                    Salvează
                    chestionar
                </div>
            </div>
