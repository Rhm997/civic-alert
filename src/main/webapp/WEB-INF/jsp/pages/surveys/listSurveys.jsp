...
<div class="viewPersonsPage">
    <div class="container-header">
        ...
        <span>
            <input type="button" class="btn btn-primary" value="Adaugă chestionar nou" onclick="addEditSurvey();">
        </span>
    </div>
    <div class="page-content">
        <table class="table table-xs" id="table_surveys" style="width: 100%;">
            <thead>
            <tr align="left">
            ...
            <tbody>
               ...
               <c:forEach items="${surveys}" var="s">
                  <tr onclick="editSurvey(${s.id})" style="cursor:pointer;">
                     <td>${s.titleRo}</td>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" style="text-align: right;">
                            <li onclick="">
                                <a href="javascript:void(0);" data-bs-toggle=""
                                   title="Editează datele" onclick="editSurvey(${s.id})">Editează datele </a>
                            </li>
                            <li onclick="">
                                <a href="javascript:void(0);" data-bs-toggle=""
                                   title="Editează structura" onclick="create_new_from(${s.id});">Creare nou din existent</a>
                            </li>
                            <li onclick="">
                                <a href="javascript:void(0);" data-bs-toggle=""
                                   title="Șterge" onclick="deleteSurvey(${s.id})">Șterge</a>
                            </li>
                        </ul>
                     </td>
                </tr>
         ...
         <div class="modal fade" id="modalCreateFromExisting" tab-index="-1" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Creare din existent</h5>
                        </div>
                        <div class="modal-body">
                           <label class="input-label"> Denumire </label>
                                              <input id="den_id" type="text" border-style="groove;" value=""/>
